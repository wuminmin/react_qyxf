...
export default class BasicDemo extends React.Component {
            ...
            <Button
              ...
              onClick={e => {
                ...
                axios({
                  ...
                  method: 'post',
                  url: 'http://223.247.193.223:18005/qyrd/rd_xia_zai_by_tittle',
            ...
            <Button
              ...
              onClick={e => {
                ...
                axios({
                  ...
                  method: 'post',
                  url: 'http://223.247.193.223:18005/qyrd/delete_wz',
                  data: Qs.stringify(data)
                }).then(function (response) {
                  console.log(response);
  ...
  componentDidMount() {
    ...
    axios({
      ...
      method: 'post',
      url: 'http://223.247.193.223:18005/qyrd/get_header_menu_list_data2',
    }).then(function (response) {
      console.log(response)
      self.setState({
  ...
  render() {
    ...
    const props2 = {
      name: 'file',
      action: 'http://223.247.193.223:18005/qyrd/upload_img2',
          ...
          <Col span={4}><Select
            ...
            onChange={(value) => {
              ...
              axios({
                ...
                method: 'post',
                url: 'http://223.247.193.223:18005/qyrd/get_tablei_data_by_lanmu',
            ...
            <Button
              ...
              onClick={e => {
                ...
                axios({
                  ...
                  method: 'post',
                  url: 'http://223.247.193.223:18005/qyrd/rd_updata',
                  data: Qs.stringify(data)
                }).then(function (response) {
                  console.log(response)
                  self.setState({
